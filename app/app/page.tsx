                    ...
                    {inputMode === "url" ? (
                      <div className="flex items-center justify-center transition-all"
                        ...
                        {isValidUrl && urlDurationLoading ? (
                          ...
                          /* Streaming service rejected: explain + link to guide */
                          <div className="flex flex-col items-center justify-center w-full gap-[6px]" style={{ position: "relative", padding: "0 24px", textAlign: "center" }}>
                            <span style={{ fontSize: 14, color: "#C8301C", fontWeight: 500, letterSpacing: "0.01em" }}>
                              {detectedRejected} links aren&rsquo;t supported.
                            </span>
                            <span style={{ fontSize: 13, color: C.textMuted, letterSpacing: "0.01em" }}>
                              Download the audio locally first, then drop the file here.
                            </span>
                            <a href="/docs/download-before-upload" target="_blank" rel="noopener noreferrer"
