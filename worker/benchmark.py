...
def run_benchmark(
    ...
    fieldnames = [
        ...
        "phase_merge_stems", "phase_compute_peaks",
        "phase_mp3_encode_total", "phase_upload_r2_total",
    ...
    for run_idx, run in enumerate(all_runs):
        ...
        try:
            ...
            rows.append({
                ...
                "phase_compute_peaks": round(phase_timings.get("compute_peaks", 0), 2),
                "phase_mp3_encode_total": round(phase_timings.get("mp3_encode_total", 0), 2),
